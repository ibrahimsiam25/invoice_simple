...
class _SummarySectionState extends State<SummarySection> {
  ...
  void initState() {
    super.initState();
    subtotalController = TextEditingController(text: widget.subtotal.toStringAsFixed(2));
    discountController = TextEditingController(text: widget.discount.toStringAsFixed(2));
  ...
  void _onValueChanged() {
    ...
    widget.onValuesChanged?.call({
      'subtotal': double.tryParse(subtotalController.text.replaceAll(',', '.')) ?? 0,
      'discount': double.tryParse(discountController.text.replaceAll(',', '.')) ?? 0,
